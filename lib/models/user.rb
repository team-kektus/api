module Models
  class User < ActiveRecord::Base
    ...
    has_attached_file :avatar,
                      ...
                      url: '/static/:attachment/users/:id/:style/:filename',
                      default_url: "/static/images/:style/missing_user_avatar.png",
                      path: "#{Config.staticfiles_path}/:attachment/users/:id/:style/:filename"
